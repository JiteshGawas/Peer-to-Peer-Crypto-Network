...
int main(int argc, char *argv[])
{
    ...
    DiscreteEventSimulator Simulator(stoi(argv[1]), stof(argv[2]), stof(argv[3]), stof(argv[4]), stof(argv[5]), 20, 100); // InterArrivalTimeMean {argv[1], argv[2] are z0 and z1}. 20 and 100 are interarrival transaction and block time respectively;
